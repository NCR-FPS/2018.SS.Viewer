...
2) Open "App.R" in R-studio either by double-clicking the "App.R" file or by opening R-studio and and using the "Open File" option (located under File -> Open File). 

3) With the "App.R" R-script open, run the application by clicking "Run App" in the upper right corner of the code. 
...
4) To close the application, click the "Stop" button (looks like a stop sign) in the console window or close R-studio. This will not automatically close the application if it is open in an external browser, however, it will remove all functionality. 
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
